...
-- ============================================================================
-- PART 10: SEED DATA (Development only)
-- ============================================================================
...
VALUES
  ...
  ('c2d3e4f5-a6b7-4890-1234-567890abcdef'::UUID, 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'::UUID, 'Revisar documentação da API', 'Atualizar a documentação com os novos endpoints', 'media', 'pendente', 'a_fazer', 15, ARRAY['docs', 'api'], 60, 0, 2),
  ('d3e4f5a6-b7c8-4901-2345-678901abcdef'::UUID, 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'::UUID, 'Implementar autenticação OAuth', 'Adicionar login com Google e GitHub', 'urgente', 'pendente', 'backlog', 40, ARRAY['auth', 'backend'], 180, 0, 3),
  ('e4f5a6b7-c8d9-4012-3456-789012abcdef'::UUID, 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'::UUID, 'Configurar CI/CD', 'Setup do pipeline de deploy automático', 'media', 'pendente', 'a_fazer', 20, ARRAY['devops', 'ci'], 90, 0, 4),
...
VALUES
  ('11111111-1111-4111-8111-111111111111'::UUID, 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'::UUID, 'Revisar notas da reunião', 'Consolidar as notas e enviar para o time', 'media', 'Reuniões', 'Hoje'),
  ('22222222-2222-4222-8222-222222222222'::UUID, 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'::UUID, 'Atualizar backlog', 'Priorizar itens para a próxima sprint', 'alta', 'Planejamento', 'Amanhã'),
  ('33333333-3333-4333-8333-333333333333'::UUID, 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'::UUID, 'Enviar feedback', 'Feedback para o estagiário sobre o último PR', 'baixa', 'Comunicação', 'Sexta')
ON CONFLICT (id) DO NOTHING;

-- Sample habit categories
INSERT INTO public.habit_categories (id, user_id, titulo, icone, cor, ordem)
VALUES
  ('aaaa1111-1111-4111-8111-111111111111'::UUID, 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'::UUID, 'Saúde', 'dumbbell', '#ef4444', 1),
...
VALUES
  ('bbbb1111-1111-4111-8111-111111111111'::UUID, 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'::UUID, 'aaaa1111-1111-4111-8111-111111111111'::UUID, 'Beber 2L de água', 'Manter-se hidratado ao longo do dia', 'diario', 15, 15, 21, true, 1),
  ('bbbb2222-2222-4222-8222-222222222222'::UUID, 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'::UUID, 'aaaa1111-1111-4111-8111-111111111111'::UUID, 'Treinar', 'Exercício físico regular', 'diario', 20, 8, 14, true, 2),
  ...
  ('bbbb4444-4444-4444-8444-444444444444'::UUID, 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'::UUID, 'aaaa1111-1111-4111-8111-111111111111'::UUID, 'Meditar 10min', 'Meditação diária', 'diario', 15, 4, 12, true, 4),
  ...
  ('bbbb6666-6666-4666-8666-666666666666'::UUID, 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'::UUID, 'aaaa2222-2222-4222-8222-222222222222'::UUID, '2h de foco profundo', 'Deep work diário', 'diario', 25, 7, 18, true, 2),
  ('bbbb7777-7777-4777-8777-777777777777'::UUID, 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'::UUID, 'aaaa2222-2222-4222-8222-222222222222'::UUID, 'Ler 30min', 'Leitura diária', 'diario', 20, 6, 22, true, 3),
  ('bbbb8888-8888-4888-8888-888888888888'::UUID, 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'::UUID, 'aaaa3333-3333-4333-8333-333333333333'::UUID, 'Alongar', 'Alongamento diário', 'diario', 10, 9, 15, true, 1)
ON CONFLICT (id) DO NOTHING;
...
VALUES
  ...
  ('cccc3333-3333-4333-8333-333333333333'::UUID, 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'::UUID, '24 livros', 'Leitura contínua', 6, 24, 'livros', 'a_fazer', 'Dezembro', 250),
  ('cccc4444-4444-4444-8444-444444444444'::UUID, 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'::UUID, '30 dias de meditação', 'Consistência diária', 30, 30, 'dias', 'concluido', 'Março', 150)
ON CONFLICT (id) DO NOTHING;
...
VALUES
  ('dddd1111-1111-4111-8111-111111111111'::UUID, 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'::UUID, 'Aprender inglês', 'Conversação com fluência intermediária', 'pessoal', 12, 30, 'em_andamento', ARRAY['30 min por dia', 'Revisar vocabulário', 'Podcast semanal'], 100),
  ('dddd2222-2222-4222-8222-222222222222'::UUID, 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'::UUID, 'Portfólio atualizado', 'Publicar 3 novos cases até março', 'profissional', 2, 3, 'em_andamento', ARRAY['Revisar materiais', 'Reunião de alinhamento'], 80),
  ('dddd3333-3333-4333-8333-333333333333'::UUID, 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'::UUID, 'Mestrado em andamento', 'Preparar inscrição e provas', 'estudos', 3, 6, 'a_fazer', ARRAY['Leituras semanais', 'Plano de estudos'], 150),
  ('dddd4444-4444-4444-8444-444444444444'::UUID, 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'::UUID, 'Especialização IA', 'Finalizar módulo avançado', 'estudos', 5, 10, 'em_andamento', ARRAY['Aulas 2x/semana', 'Projetos práticos'], 120)
ON CONFLICT (id) DO NOTHING;
